...
const apiKey= "1e80cc781b76a58d45ee8b4110bd0bb9";
...
const apiPaths= {
    ...
    searchOnYoutube: (query) => `https://www.googleapis.com/youtube/v3/search?part=snippet&q=${query}&key=AIzaSyC7oijvORCK2_8kYWEZNvweufYUcURHr0Q`
...
function buildBannerSection(movie){
    ...
    div.innerHTML = `
            ...
            <p class="banner__overview">${movie.overview && movie.overview.length > 210 ? movie.overview.slice(0,200).trim()+ '...':movie.overview}</p>
